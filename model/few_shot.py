...
class FewShot(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx) -> torch.FloatTensor:
        ...
        if batch_idx % self.log_freq == 0:
            self.logger.experiment.log({'train/loss': _loss})
    ...
    def on_train_epoch_end(self) -> None:
        ...
        self.logger.experiment.log({'train/acc_per_epoch': _global_acc})
    ...
    def validation_step(self, batch, batch_idx) -> torch.FloatTensor:
        ...
        if batch_idx % self.log_freq == 0:
            self.logger.experiment.log({'valid/loss': _loss})
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        self.logger.experiment.log({'valid/acc_per_epoch': _global_acc})
